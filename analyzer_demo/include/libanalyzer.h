...
typedef int (*func_analyzer_bio_output)(void *p, const char *file, size_t line,
        const char *str);
typedef int (*func_analyzer_bio_input)(void *p, char *buf, size_t size,
        size_t *len);
...
typedef void (*func_analyzer_set_memory_alloc)(func_analyzer_bio_alloc f_alloc,
        func_analyzer_bio_free f_free, void *p);
typedef void (*func_analyzer_set_debug)(func_analyzer_bio_output f_out,
        func_analyzer_bio_input f_in, void *p);
typedef void (*func_analyzer_set_mark_point)(
        func_analyzer_bio_mark_point f, void *p);
typedef void (*func_analyzer_set_mark_line)(
        func_analyzer_bio_mark_line f, void *p);

typedef size_t analyzer_context;
typedef int (*func_analyzer_init)(analyzer_context *ctx);
